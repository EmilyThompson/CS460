...
<div id="page-wrap" align="center">
		...
		<table align="center" style="width: 65%;">
			...
			<tr align="center">
				...
				<input id="10hours" name="studyhours" type="radio" <?php if(isset($StudyHours) && $StudyHours=='10hours') echo 'checked';?> value="10hours"><label for="10hours"><img alt="icon" height="100x" src="images/10hours%20icon.png" width="100px"></label>
				<input id="5to10hours" name="studyhours" type="radio" <?php if(isset($StudyHours) && $StudyHours=='5to10hours') echo 'checked';?> value="5to10hours"><label for="5to10hours"><img alt="icon" height="100x" src="images/5to10hours%20icon.png" width="100px"></label>
				<input id="barelystudy" name="studyhours" type="radio" <?php if(isset($StudyHours) && $StudyHours=='barelystudy') echo 'checked';?> value="barelystudy"><label for="barelystudy"><img alt="icon" height="100x" src="images/barelystudy%20icon.png" width="100px"></label>
				</td>
				<td>
				<p id="question">Where do you prefer to study?</p>
				<input id="library" name="studylocation" type="radio" <?php if(isset($StudyLocation) && $StudyLocation=='library') echo 'checked';?> value="library"><label for="library"><img alt="icon" height="100x" src="images/library%20icon.png" width="100px"></label>
				<input id="dorm" name="studylocation" type="radio" <?php if(isset($StudyLocation) && $StudyLocation=='dorm') echo 'checked';?> value="dorm"><label for="dorm"><img alt="icon" height="100x" src="images/dorm%20icon.png" width="100px"></label>
				<input id="anywhere" name="studylocation" type="radio" <?php if(isset($StudyLocation) && $StudyLocation=='anywhere') echo 'checked';?> value="anywhere"><label for="anywhere"><img alt="icon" height="100x" src="images/anywhere%20icon.png" width="100px"></label>
				</td>
			</tr> <!--fourth row = habits="" row="sleeping"-->
			<tr align="center">
				<td>
				<p id="question">What are your sleeping habits?</p>
				<input id="earlyriser" name="sleephours" type="radio" <?php if(isset($SleepHours) && $SleepHours=='earlyriser') echo 'checked';?> value="earlyriser"><label for="earlyriser"><img alt="icon" height="100x" src="images/earlyriser%20icon.png" width="100px"></label>
				<input id="10to12" name="sleephours" type="radio" <?php if(isset($SleepHours) && $SleepHours=='10to12') echo 'checked';?> value="10to12"><label for="10to12"><img alt="icon" height="100x" src="images/10to12%20icon.png" width="100px"></label>
				<input id="nightowl" name="sleephours" type="radio" <?php if(isset($SleepHours) && $SleepHours=='nightowl') echo 'checked';?> value="nightowl"><label for="nightowl"><img alt="icon" height="100x" src="images/nightowl%20icon.png" width="100px"></label>
				</td>
				<td>
				<p id="question">What type of sleeper are you?</p>
				<input id="lightsleeper" name="sleepertype" type="radio" <?php if(isset($SleeperType) && $SleeperType=='lightsleeper') echo 'checked';?> value="lightsleeper"><label for="lightsleeper"><img alt="icon" height="100x" src="images/lightsleeper%20icon.png" width="100px"></label>
				<input id="averagesleeper" name="sleepertype" type="radio" <?php if(isset($SleeperType) && $SleeperType=='averagesleeper') echo 'checked';?> value="averagesleeper"><label for="averagesleeper"><img alt="icon" height="100x" src="images/averagesleeper%20icon.png" width="100px"></label>
				<input id="heavysleeper" name="sleepertype" type="radio" <?php if(isset($SleeperType) && $SleeperType=='heavysleeper') echo 'checked';?> value="heavysleeper"><label for="heavysleeper"><img alt="icon" height="100x" src="images/heavysleeper%20icon.png" width="100px"></label>
				</td>
			</tr>
			...
			<tr align="center">
				...
				<input id="cleanmachine" name="cleaning" type="radio" <?php if(isset($CleaningHabits) && $CleaningHabits=='cleanmachine') echo 'checked';?> value="cleanmachine"><label for="cleanmachine"><img alt="icon" height="100x" src="images/cleanmachine%20icon.png" width="100px"></label>
				<input id="helpout" name="cleaning" type="radio" <?php if(isset($CleaningHabits) && $CleaningHabits=='helpout') echo 'checked';?> value="helpout"><label for="helpout"><img alt="icon" height="100x" src="images/helpout%20icon.png" width="100px"></label>
			...
			<tr align="center">
				...
				<input id="friends_allthetime" name="friendsover" type="radio" <?php if(isset($FriendsOver) && $FriendsOver=='friends_allthetime') echo 'checked';?> value="friends_allthetime"><label for="friends_allthetime"><img alt="icon" height="100x" src="images/all%20the%20time%20icon.png" width="100px"></label>
				<input id="friends_sometimes" name="friendsover" type="radio" <?php if(isset($FriendsOver) && $FriendsOver=='friends_sometimes') echo 'checked';?> value="friends_sometimes"><label for="friends_sometimes"><img alt="icon" height="100x" src="images/sometimes%20icon.png" width="100px"></label>
				<input id="friends_notoften" name="friendsover" type="radio" <?php if(isset($FriendsOver) && $FriendsOver=='friends_notoften') echo 'checked';?> value="friends_notoften"><label for="friends_notoften"><img alt="icon" height="100x" src="images/not%20often%20icon.png" width="100px"></label>
				</td>
				<td>
				<p id="question" align="center">How often do you have overnight 
				guests?</p>
				<input id="overnight_allthetime" name="overnightguest" type="radio" <?php if(isset($OvernightGuests) && $OvernightGuests=='overnight_allthetime') echo 'checked';?> value="overnight_allthetime"><label for="overnight_allthetime"><img alt="icon" height="100x" src="images/all%20the%20time%20icon.png" width="100px"></label>
				<input id="overnight_sometimes" name="overnightguest" type="radio" <?php if(isset($OvernightGuests) && $OvernightGuests=='overnight_sometimes') echo 'checked';?> value="overnight_sometimes"><label for="overnight_sometimes"><img alt="icon" height="100x" src="images/sometimes%20icon.png" width="100px"></label>
				<input id="overnight_notoften" name="overnightguest" type="radio" <?php if(isset($OvernightGuests) && $OvernightGuests=='overnight_notoften') echo 'checked';?> value="overnight_notoften"><label for="overnight_notoften"><img alt="icon" height="100x" src="images/not%20often%20icon.png" width="100px"></label>
				</td>
			</tr>
			...
			<tr align="center">
				...
				social gatherings?</p>
				<input id="roommatefriends_allthetime" name="roommate_friendsover" type="radio" <?php if(isset($Roommate_friendsover) && $Roommate_friendsover=='roommatefriends_allthetime') echo 'checked';?> value="roommatefriends_allthetime"><label for="roommatefriends_allthetime"><img alt="icon" height="100x" src="images/whenever%20they%20want%20icon.png" width="100px"></label>
				<input id="roommatefriends_sometimes" name="roommate_friendsover" type="radio" <?php if(isset($Roommate_friendsover) && $Roommate_friendsover=='roommatefriends_sometimes') echo 'checked';?> value="roommatefriends_sometimes"><label for="roommatefriends_sometimes"><img alt="icon" height="100x" src="images/once%20in%20awhile%20icon.png" width="100px"></label>
				<input id="roommatefriends_notoften" name="roommate_friendsover" type="radio" <?php if(isset($Roommate_friendsover) && $Roommate_friendsover=='roommatefriends_notoften') echo 'checked';?> value="roommatefriends_notoften"><label for="roommatefriends_notoften"><img alt="icon" height="100x" src="images/not%20comfortable%20icon.png" width="100px"></label>
				</td>
				<td>
				<p id="question" align="center">How do you feel abouty our roommate<br>
				hosting overnight guests?</p>
				<input id="roommateovernight_allthetime" name="roommate_overnightguest" type="radio" <?php if(isset($Roommate_overnightguest) && $Roommate_overnightguest=='roommateovernight_allthetime') echo 'checked';?> value="roommateovernight_allthetime"><label for="roommateovernight_allthetime"><img alt="icon" height="100x" src="images/whenever%20they%20want%20icon.png" width="100px"></label>
				<input id="roommateovernight_sometimes" name="roommate_overnightguest" type="radio" <?php if(isset($Roommate_overnightguest) && $Roommate_overnightguest=='roommateovernight_sometimes') echo 'checked';?> value="roommateovernight_sometimes"><label for="roommateovernight_sometimes"><img alt="icon" height="100x" src="images/once%20in%20awhile%20icon.png" width="100px"></label>
				<input id="roommateovernight_notoften" name="roommate_overnightguest" type="radio" <?php if(isset($Roommate_overnightguest) && $Roommate_overnightguest=='roommateovernight_notoften') echo 'checked';?> value="roommateovernight_notoften"><label for="roommateovernight_notoften"><img alt="icon" height="100x" src="images/not%20comfortable%20icon.png" width="100px"></label>
				</td>
			</tr>
			...
			<tr align="center">
				...
				<input id="friendship" name="expectations" type="radio" <?php if(isset($Expectations) && $Expectations=='friendship') echo 'checked';?> value="friendship"><label for="friendship"><img alt="icon" height="100x" src="images/friendship%20icon.png" width="100px"></label>
				<input id="connection" name="expectations" type="radio" <?php if(isset($Expectations) && $Expectations=='connection') echo 'checked';?> value="connection"><label for="connection"><img alt="icon" height="100x" src="images/connection%20icon.png" width="100px"></label>
				<input id="respect" name="expectations" type="radio" <?php if(isset($Expectations) && $Expectations=='respect') echo 'checked';?> value="respect"><label for="respect"><img alt="icon" height="100x" src="images/respect%20icon.png" width="100px"></label>
				</td>
				<td>
				<p id="question" align="center">What is your comfort level sharing
				<br>personal belongings?</p>
				<input id="anytimeshare" name="sharing" type="radio" <?php if(isset($Sharing) && $Sharing=='anytimeshare') echo 'checked';?> value="anytimeshare"><label for="anytimeshare"><img alt="icon" height="100x" src="images/anytimeshare%20icon.png" width="100px"></label>
				<input id="asktoshare" name="sharing" type="radio" <?php if(isset($Sharing) && $Sharing=='asktoshare') echo 'checked';?> value="asktoshare"><label for="asktoshare"><img alt="icon" height="100x" src="images/asktoshare%20icon.png" width="100px"></label>
				<input id="nosharing" name="sharing" type="radio" <?php if(isset($Sharing) && $Sharing=='nosharing') echo 'checked';?> value="nosharing"><label for="nosharing"><img alt="icon" height="100x" src="images/no%20sharing%20icon.png" width="100px"></label>
				</td>
			</tr>
		</table>
		<br><br>
