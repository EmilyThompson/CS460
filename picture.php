...
<form action="picturePHP.php" method="POST" enctype="multipart/form-data">
    ...
    <input type="submit" id="submit" value="Upload Picture" name="submit" style="width: 159px; height: 44px">
</form>
<a href="create_account.php"><button id="submit" style="width: 159px">Skip &#10095; </button></a>
</div>
</body>
</html>